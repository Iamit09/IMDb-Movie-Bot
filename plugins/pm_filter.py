...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/theamozonflix'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/theamozonflix')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/theamozonflix')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/theamozonflix'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/theamozonflix')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/Amozonflix'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie", url="https://t.me/theamozonflix"),
        InlineKeyboardButton("Series ⭕️", url="https://t.me/theamozonflix")
    ])
    btn.insert(0, [
